# Neon Sumo architecture notes

This document is the detailed SDK walkthrough previously kept in the sample README. For setup and a short feature list, see [README.md](../README.md).
