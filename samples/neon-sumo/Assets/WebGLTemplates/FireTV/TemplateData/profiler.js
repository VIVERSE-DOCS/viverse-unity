let unityProfiler = (function () {
  ...
  function isProfilerSupported(ui) {
    return ui && typeof ui.IsConnectedToProfiler === 'function'
      && typeof ui.ConnectToProfiler === 'function'
      && typeof ui.StopProfiling === 'function';
  }

  return {
    createButton: (unityInstance) => {
      if (!isProfilerSupported(unityInstance)) {
        return null;
      }
    ...
    shutDown: () => {
      if (profilerButton && profilerButton.parentNode) {
        profilerButton.remove();
      }
