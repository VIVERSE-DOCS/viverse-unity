...
namespace Viverse.NativeWebSocket
{
  ...
  public class WebSocket : IWebSocket {
    ...
    public static extern int ViverseWebSocketConnect (int instanceId);

    [DllImport ("__Internal")]
    public static extern int ViverseWebSocketClose (int instanceId, int code, string reason);

    [DllImport ("__Internal")]
    public static extern int ViverseWebSocketSend (int instanceId, byte[] dataPtr, int dataLength);

    [DllImport ("__Internal")]
    public static extern int ViverseWebSocketSendText (int instanceId, string message);

    [DllImport ("__Internal")]
    public static extern int ViverseWebSocketGetState (int instanceId);
    ...
    public WebSocket (string url, Dictionary<string, string> headers = null) {
      ...
      int instanceId = WebSocketFactory.ViverseWebSocketAllocate (url);
    ...
    public WebSocket (string url, string subprotocol, Dictionary<string, string> headers = null) {
      ...
      WebSocketFactory.ViverseWebSocketAddSubProtocol(instanceId, subprotocol);
    ...
    public Task Connect () {
      int ret = ViverseWebSocketConnect (this.instanceId);
    ...
    public Task Close (WebSocketCloseCode code = WebSocketCloseCode.Normal, string reason = null) {
      int ret = ViverseWebSocketClose (this.instanceId, (int) code, reason);
    ...
    public Task Send (byte[] data) {
      int ret = ViverseWebSocketSend (this.instanceId, data, data.Length);
    ...
    public Task SendText (string message) {
      int ret = ViverseWebSocketSendText (this.instanceId, message);
    ...
    public WebSocketState State {
      get {
        int state = ViverseWebSocketGetState (this.instanceId);
    ...
    [DllImport ("__Internal")]
    public static extern int ViverseWebSocketAllocate (string url);

    [DllImport ("__Internal")]
    public static extern int ViverseWebSocketAddSubProtocol (int instanceId, string subprotocol);

    [DllImport ("__Internal")]
    public static extern void ViverseWebSocketFree (int instanceId);

    [DllImport ("__Internal")]
    public static extern void ViverseWebSocketSetOnOpen (OnOpenCallback callback);

    [DllImport ("__Internal")]
    public static extern void ViverseWebSocketSetOnMessage (OnMessageCallback callback);

    [DllImport ("__Internal")]
    public static extern void ViverseWebSocketSetOnError (OnErrorCallback callback);

    [DllImport ("__Internal")]
    public static extern void ViverseWebSocketSetOnClose (OnCloseCallback callback);
    ...
    public static void Initialize () {
      ...
      ViverseWebSocketSetOnOpen (DelegateOnOpenEvent);
      ViverseWebSocketSetOnMessage (DelegateOnMessageEvent);
      ViverseWebSocketSetOnError (DelegateOnErrorEvent);
      ViverseWebSocketSetOnClose (DelegateOnCloseEvent);
    ...
    public static void HandleInstanceDestroy (int instanceId) {
      ...
      ViverseWebSocketFree (instanceId);
